...
var meshNormalShader = new pe.shaders.MeshNormalShader(app.$.graphicsDevice);
var meshNormalMaterial = new pc.Material();
meshNormalMaterial.setShader(meshNormalShader);
...
Promise.all([
    ...
    Promise.all([
        ...
        cube.model.meshInstances.forEach(mi => {
            mi.material = meshNormalMaterial;
        });
